...
NetParams = namedtuple(
    "NetParams", "ip netmask mac gw server far com mode dhcp")
RecordsInfo = namedtuple(
    "RecordsInfo", "users fingerprints passwords cards all_records new_records")
...
StaffInfo = namedtuple(
    "StaffInfo", "code pwd card name dep group mode fp special")
